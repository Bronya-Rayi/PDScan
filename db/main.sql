...
-- ----------------------------
-- Table structure for pdscan_site_path_scan
-- ----------------------------
DROP TABLE IF EXISTS "pdscan_site_path_scan";
CREATE TABLE "pdscan_site_path_scan" (
  "id" INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
  "task_id" TEXT NOT NULL,
  "url" TEXT NOT NULL
);
...
CREATE TABLE "pdscan_task" (
  ...
  "task_module_list" TEXT NOT NULL,
  "task_running_module" TEXT NOT NULL,
  "task_status" TEXT NOT NULL,
  "task_start_time" TEXT,
  "task_end_time" TEXT,
  "celery_id" text,
  "task_portscan_range" TEXT,
  "task_target_type" TEXT,
  "task_c_duan" TEXT
);

-- ----------------------------
-- Table structure for pdscan_tool_conf
-- ----------------------------
DROP TABLE IF EXISTS "pdscan_tool_conf";
CREATE TABLE "pdscan_tool_conf" (
  "id" integer NOT NULL PRIMARY KEY AUTOINCREMENT,
  "tool_name" TEXT NOT NULL,
  "tool_cmd" TEXT NOT NULL,
  "tool_log_path" TEXT,
  "tool_result_path" TEXT,
  "tool_update_sh" TEXT,
  "tool_others" TEXT
);
...
-- ----------------------------
-- Table structure for pdscan_user
-- ----------------------------
DROP TABLE IF EXISTS "pdscan_user";
CREATE TABLE "pdscan_user" (
  "id" INTEGER NOT NULL,
  "username" VARCHAR(20),
...
-- ----------------------------
-- Records of pdscan_user
-- ----------------------------
INSERT INTO "pdscan_user" VALUES (1, 'admin', 'pbkdf2:sha256:260000$VyyzvgWfcKS1uhly$49f1c88ab3f07585a6a938e8377c44cb95d3abab68b732ab12bbc48ca637af44');
